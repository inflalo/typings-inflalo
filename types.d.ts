...
import { Paises, Roles, EstatusPlanificacion, Sistemas, NivelResultado, Categorias, SubCategorias, PeriodosGarantia } from "./enums";
...
export type DatosResponsable = Omit<DatosUsuario, "empresa" | "nif" | "idDireccion">;
